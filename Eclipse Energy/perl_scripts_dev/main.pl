...
#use sites::enagas_monthly;Site::enagas_monthly->register(\%site);
...
use sites::entsoe_consumption;Site::entsoe_consumption->register(\%site);
#use sites::tigf_allocations_storage;Site::tigf_allocations_storage->register(\%site);
